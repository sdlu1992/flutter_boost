...
public class XTextInputPlugin {
    ...
    @NonNull private InputMethodManager mImm;
    @NonNull private AutofillManager afm;
    ...
    public  static  XTextInputPlugin getTextInputPlugin(View view, TextInputChannel textInputChannel, @NonNull PlatformViewsController platformViewsController){
        if(xTextInputPlugin!=null) return xTextInputPlugin;
        xTextInputPlugin =new XTextInputPlugin(view, textInputChannel,platformViewsController);
        return  xTextInputPlugin;
    }

    @SuppressLint("NewApi")
    public XTextInputPlugin(
            View view,
